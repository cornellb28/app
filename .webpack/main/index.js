...
exports.isDirectory = exports.fetchDirData = exports.fetchFilesData = void 0;
const fs = __importStar(__webpack_require__(/*! fs */ "fs"));
const fg = __webpack_require__(/*! fast-glob */ "./node_modules/fast-glob/out/index.js");
function fetchFilesData(data) {
    console.log("This is File(s):  " + typeof data);
}
exports.fetchFilesData = fetchFilesData;
async function fetchDirData(data) {
    const scanSelectedDir = (data) => {
        return new Promise((resolve, reject) => {
            data?.forEach((d) => {
...
electron_1.ipcMain.handle("upload-files", async (event, args) => {
    ...
    if (selectedPath && (0, utils_1.isDirectory)(selectedPath)) {
        ...
        const dir = await (0, utils_1.fetchDirData)(selectedPath);
        console.log("dir: ", dir);
    }
    else {
